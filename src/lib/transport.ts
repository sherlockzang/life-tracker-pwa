...
export function normalizeTransportDetails(type: TransportType, value: unknown): TransportDetails | null {
  ...
  if (type === "flight") {
    ...
    return {
      ...
      departure: { date: stringValue(departure.date), time: stringValue(departure.time), airport: stringValue(departure.airport), terminal: stringValue(departure.terminal) },
      arrival: { date: stringValue(arrival.date), time: stringValue(arrival.time), airport: stringValue(arrival.airport), terminal: stringValue(arrival.terminal) },
